...
plt.gca().xaxis.set_label_coords(0.5, -0.025)
...
inset_ax.set_ylabel(r'$\langle n(r) \rangle$', fontsize=15, rotation = 0, labelpad=30)
inset_ax.yaxis.tick_right()
inset_ax.yaxis.set_label_position("right")
inset_ax.xaxis.set_label_position("top")
inset_ax.xaxis.tick_top()
plt.text(0.05, 0.975, 'a)', transform=plt.gcf().transFigure, 
         fontsize=24, fontweight='bold', verticalalignment='top', 
         horizontalalignment='right')
inset_ax.tick_params(labelsize=12)
plt.tight_layout()
plt.savefig("Figure_3c_supp.pdf", format="pdf", bbox_inches='tight')
plt.show()